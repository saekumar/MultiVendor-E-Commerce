...
const Sponsered = () => {
  return (
    <div
      className={`${styles.section} hidden shadow-2xl sm:block bg-orange-100 py-10 px-5 mb-12 cursor-pointer rounded-xl`}
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://www.vectorlogo.zone/logos/twitch/twitch-ar21.svg"
            style={{ width: '150px', objectFit: 'contain' }}
            alt=""
          />
        </div>
