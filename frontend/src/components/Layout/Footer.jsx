    ...
    <div className="bg-[#000] text-white">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-orange-500 py-7">
        <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5">
          <span className="text-gray-950">Subscribe</span> for news,
          <br />
          events, and offers
        </h1>
        <div>
          ...
          />
          <button className="bg-gray-900 hover:bg-gray-950 duration-300 px-5 py-2.5 rounded-md text-whie md:w-auto w-full">
            Submit
          </button>
        </div>
      </div>
      ...
      >
        <span>© 2024 SaeNus. All rights reserved.</span>
